...
import { ADMIN_AT_A_GLANCE_EDIT } from '@/lib/AdminPanelRoute';
        ...
        <div className="min-h-screen bg-gray-100 p-4 md:p-8 flex flex-col items-center justify-start font-sans">
            <form onSubmit={handleSubmit} className="w-full max-w-5xl bg-white border border-gray-300 shadow-md text-sm md:text-base text-black mb-8">
                ...
                <div className="bg-gray-50 border-t border-gray-300 p-4 flex justify-end space-x-3">
                    <button type="button" onClick={handleClear} className="px-5 py-2 bg-gray-200 text-gray-700 font-semibold rounded hover:bg-gray-300 transition duration-150">
                        Clear Form
                    </button>
                    <button type="submit" className="px-6 py-2 bg-blue-600 text-white font-semibold rounded hover:bg-blue-700 shadow transition duration-150">
                        Save Data
                    </button>
                </div>
