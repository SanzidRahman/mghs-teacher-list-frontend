...
const LoginPage = () => {
  ...
  const handleLoginSubmit = async (values) => {
    try {
      setLoading(true);
      const { data: response } = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/auth/register`, values);
  ...
  return (
    <div className="flex mt-4 justify-center bg-linear-to-r from-blue-400 via-white to-blue-100 px-4">
